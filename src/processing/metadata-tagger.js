 ...
 * @typedef {import("../types/core-contracts.d.ts").ChunkTags} ChunkTags
 * @typedef {import("../types/core-contracts.d.ts").TaggingContext} TaggingContext
 ...
 * @returns {string[]}
 */
function extractTopics(words, limit = 5) {
 ...
 */
function computeComplexity(sentences, words) {
 ...
 */
function computeReadingLevel(words) {
 ...
 * @returns {ChunkTags}
 */
export function tagChunk(chunk, context) {
